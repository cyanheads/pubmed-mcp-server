...
If you don't see any MCP tools from this server, ask the user to connect it first (e.g. `Codex mcp add` for Codex, or the equivalent for their client). Don't proceed until the tools are visible.
